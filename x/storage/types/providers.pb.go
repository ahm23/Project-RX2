...
// source: nebulix/storage/v1/providers.proto
...
func (*Providers) Descriptor() ([]byte, []int) {
	return fileDescriptor_a8907020f11252fb, []int{0}
}
...
func (m *Providers) GetHostname() string {
	if m != nil {
		return m.Hostname
	}
	return ""
...
func (m *Providers) GetTotalspace() int64 {
	if m != nil {
		return m.Totalspace
	}
	return 0
...
func init() {
	proto.RegisterType((*Providers)(nil), "nebulix.storage.v1.Providers")
}

func init() {
	proto.RegisterFile("nebulix/storage/v1/providers.proto", fileDescriptor_a8907020f11252fb)
}

var fileDescriptor_a8907020f11252fb = []byte{
	// 227 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *Providers) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Totalspace != 0 {
		i = encodeVarintProviders(dAtA, i, uint64(m.Totalspace))
		i--
		dAtA[i] = 0x20
	}
	if len(m.Creator) > 0 {
	...
	if len(m.Hostname) > 0 {
		...
		i = encodeVarintProviders(dAtA, i, uint64(len(m.Hostname)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Address) > 0 {
...
func (m *Providers) Size() (n int) {
	...
	if m.Totalspace != 0 {
		n += 1 + sovProviders(uint64(m.Totalspace))
	}
